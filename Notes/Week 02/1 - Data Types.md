...
* A **local variable** is a variable that is declared within a local scope (i.e. only a specifc section of the program). It may be accessed and modified only within the context it was declared in. It is lost when its context is completed.
